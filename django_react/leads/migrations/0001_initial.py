...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.ForeignKey(blank=True, default=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.department')),
                ('profile', models.ForeignKey(blank=True, default=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.profile')),
                ('project', models.ForeignKey(blank=True, default=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.project')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
            fields=[
                ...
                ('status', models.CharField(choices=[('Active', 'Active'), ('Archived', 'Archived'), ('Deleted', 'Deleted')], default='Active', max_length=50)),
                ('sourceID', models.ForeignKey(default=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.source')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='project',
            name='sourceID',
            field=models.ForeignKey(default=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.source'),
        ),
        migrations.CreateModel(
            name='projDepartment',
            fields=[
        ...
        migrations.AddField(
            model_name='profile',
            name='sourceID',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.source'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
            field=annoying.fields.AutoOneToOneField(default=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='postsAIAD',
            fields=[
        ...
        migrations.AddField(
            model_name='post',
            name='sourceID',
            field=models.ForeignKey(default='1', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.source'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
        ...
        migrations.AddField(
            ...
            name='sourceID',
            field=annoying.fields.AutoOneToOneField(default=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leads.source'),
        ),
        migrations.CreateModel(
            name='depAIAD',
            fields=[
